...
$t_id= $_GET['room_id'];
$sql2= "DELETE FROM room WHERE id='$t_id' ";
        ...
        <table border="1px">
            ...
            <tr>
                ...
                <td class="table_td">
                 ...
                 <img  height="100px" width="100px" src="image/<?php echo "{$info['image']}"; ?>"alt="room image"/> </td>
              
                <td class="table_td">
                    <?php echo "<a  onClick=\"javascript:return confirm('are you sure to delete'); \"
                    href='admin_view_room.php?room_id={$info['id']}' class='btn btn-danger'>Delete</a>"; ?></td>

              <td class="table_td">
                <?php echo "
                <a href='admin_update_room.php?room_id= {$info['id']}' class='btn btn-primary'>Update</a> "; ?>
              </td>
            </tr>
            <?php
            }
