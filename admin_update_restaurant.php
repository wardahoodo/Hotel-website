...
error_reporting(0);
    ...
    $data = mysqli_connect($host,$user,$password,$db);
        ...
        $sql= "SELECT * FROM restaurant WHERE  id='$t_id' ";
    ...
    move_uploaded_file($_FILES['image']['tmp_name'],$dst);
        ...
        if($file){
            $sql2= "UPDATE restaurant SET  name='$t_name', description='$t_description',
...
<head>
    ...
    <title>Update Restaurant Data</title>
    <?php
    ...
    <div class="content">
        ...
        <div class="div_deg">
            ...
            <input type="text" name="id" value="<?php echo "{$info['id']}"; ?>" hidden>
             ...
             <div>
                    <label>Restaurant Old  Image</label>

                    <img  height="100px" width="100px" src="image/<?php echo "{$info['image']}"; ?>"alt="restaurant image"   /> 
                </div>
                <div>
                    <label>Choose new image for restaurant </label>
                    <input type="file" name="image" value="<?php echo "{$info['image']}"; ?>">
                </div>
                
                <div>
                    
                    <input  class="btn btn-success" type="submit" name="update_restaurant" value="update">
                </div>
            </form>
        </div>
        </center>
